    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="../assets/images/users/5.jpg"
                                    ...
                                    <h4 class="card-title m-t-10">Ssemwogerere Stanslas</h4>
                                    <h6 class="card-subtitle">Student</h6>
                                    <div class="row text-center justify-content-md-center">
                                        <div class="col-4"><a href="javascript:void(0)" class="link"><i
                                                    class="icon-people"></i>
                                                <font class="font-medium">18</font>
                                            </a></div>
                                        <div class="col-4"><a href="javascript:void(0)" class="link"><i
            ...
            <footer class="footer text-center">
                All Rights Reserved by  CFA. Designed and Developed by <a
                    href="https://www.wrappixel.com">CFA</a>.
            </footer>
